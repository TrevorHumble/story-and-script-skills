...
Usage (called via the batch wrapper):
...
Defaults are tuned for animatic speed: half-resolution (960x540), EEVEE engine,
PNG output. Tune SETTINGS below or override per scene by editing each .blend's
render properties before calling.
"""
import bpy
import sys
import os
...
FRAME_RATE = 24
ENGINE = "BLENDER_EEVEE_NEXT"  # Blender 5.x EEVEE; fall back to BLENDER_EEVEE for 4.x
FILE_FORMAT = "PNG"
# ================
...
def main():
    ...
    # Engine — fall back gracefully if EEVEE_NEXT not available
    try:
